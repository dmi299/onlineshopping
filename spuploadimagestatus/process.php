...
$status = (boolean) move_uploaded_file($_FILES['photo']['tmp_name'], '../filesanpham/'.$filename.$extension);
...
if ($status) {
	$response->url = 'http://localhost:9000/cuahangraucuqua/filesanpham/'.$filename.$extension;
